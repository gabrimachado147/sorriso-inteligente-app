...
const AppointmentsPageReal = () => {
  ...
  return (
    <>
      <PageHead
        title="Minhas Consultas - Senhor Sorriso"
        description="Gerencie seus agendamentos e consulte o histórico de consultas na rede Senhor Sorriso."
        keywords="minhas consultas, agendamentos, histórico consultas, gestão agendamentos, Senhor Sorriso"
        url="https://senhorsorrisso.com.br/appointments"
      />
