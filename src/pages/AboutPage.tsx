          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-1/3">
                  <div className="bg-blue-600 text-white p-6 rounded-lg text-center">
                    ...
                    <h3 className="text-2xl font-bold">2014</h3>
                    <p>Início da Jornada</p>
                  </div>
                </div>
                <div className="md:w-2/3">
                  <h3 className="text-2xl font-bold mb-4">Fundação em Campo Belo</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-1/3 md:order-2">
                  <div className="bg-green-600 text-white p-6 rounded-lg text-center">
                    ...
                    <p>Expansão Regional</p>
                  </div>
                </div>
                <div className="md:w-2/3 md:order-1">
                  <h3 className="text-2xl font-bold mb-4">Crescimento e Expansão</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="md:w-2/3">
                  <h3 className="text-2xl font-bold mb-4">Expansão para São Paulo</h3>
                  <p className="text-gray-600">
